...
export const plants            = new PIXI.display.Group(1, true);
...
export function init() {
	[background,defaults,  water, floor, plants, wall, dynamicBack, avatar, dynamicFront, select, ui, user, tooltips].forEach(layer => {
