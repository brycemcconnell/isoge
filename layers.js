...
export const backTrees        = new PIXI.display.Group(-1, true);
...
export const actors           = new PIXI.display.Group(4, true);
export const dynamicFront     = new PIXI.display.Group(5, true);
export const select           = new PIXI.display.Group(6, true);
export const clouds           = new PIXI.display.Group(7, true);
export const ui               = new PIXI.display.Group(8, true);
export const user             = new PIXI.display.Group(9, true);
export const tooltips         = new PIXI.display.Group(10, true);
export function init() {
	[background,defaults, backTrees, water, floor, wall, dynamicBack, actors, dynamicFront, select, clouds, ui, user, tooltips].forEach(layer => {
